...
def main():
    ...
    train_json = format_data(train_data, "glue-sst2")
    # dev_json = format_data(dev_data, "glue-sst2")
    # test_json = format_data(test_data, "glue-sst2")
    ...
    save_jsonl(train_json, os.path.join(path, "glue-sst2_train.jsonl"))
    # save_jsonl(dev_json, os.path.join(path, "glue-sst2_dev.jsonl"))
    # save_jsonl(test_json, os.path.join(path, "glue-sst2_test.jsonl"))
