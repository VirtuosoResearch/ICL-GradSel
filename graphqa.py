...
def main(logger, args):
    ...
    for seed in seeds:
        ...
        test_data = train_dataset.map(transform_graphqa)
        #val_data = eval_dataset.map(transform_graphqa)
...
def run(logger, task, metaicl_data, metaicl_model, test_data, val_data, seed,
    ...
    if args.topk:
        ...
        metaicl_data.tensorize_topkcon(args.gpt2, test_data, val_data, options=None,  add_newlines=add_newlines)
