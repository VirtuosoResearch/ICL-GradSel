...
class Model(pl.LightningModule):
    ...
    def __init__(self, model, tokenizer: PreTrainedTokenizerBase, model_type: str, use_cpu_offload=False,
                 ...
                 train_nsm=False, nsm_use_neg=False, nsm_sigma=0.01, nsm_num_perturbs=1, nsm_lam = 0, optimizer="adamw", generate_outputs=False):
        """
    ...
    def validation_step(self, batch, batch_idx) -> Dict[str, torch.Tensor]:
        ...
        if self.generate_outputs:
            ...
            output = batch["input_ids"].clone()[:, :1]
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if self.global_rank == 0:
            ...
            if self.completion_metadata is not None:
                ...
                summary.update(summarize_evaluation(evaluation))
